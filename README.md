...
Batch script สำหรับตั้งค่าประสิทธิภาพระบบ Disk cleanup และ ลบ Temp Files/ประวัติเบราเซอร์ และ ปรับปรุงประสิทธิภาพไดร์ฟ (HDD/SSD)
...
5. **Usage Workflow**
   ...
   * เลือก Option 2 เพื่อรันสคริปต์ Disk Cleanup & Tempfiles & Defrag and optimize disk
   * เลือก Option 3 เคลียร์แคชและคุกกี้บนเบราเซอร์ (Chrome, Edge, Firefox)
